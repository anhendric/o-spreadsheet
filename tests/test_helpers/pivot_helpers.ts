...
export const SELECTORS = {
  COG_WHEEL: ".o-icon-cog",
  DUPLICATE_PIVOT: ".o-menu-item[data-name='duplicate_pivot']",
  DELETE_PIVOT: ".o-menu-item[data-name='delete_pivot']",
  FLIP_AXIS_PIVOT: ".o-menu-item[data-name='flip_axis']",
